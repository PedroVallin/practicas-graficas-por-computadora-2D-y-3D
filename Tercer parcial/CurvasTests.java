...
public class CurvasTests extends JFrame implements KeyListener {
    ...
    private void dibujarCurva(Graphics g) {
        ...
        for (double t = tInicio; t <= tFin; t += paso) {
            ...
            double x = Math.cos(3 * t);
            double y = 2 * Math.pow(Math.cos(t), 2);
            double z = Math.sin(2 * t);
    ...
    public static void main(String[] args) {
        CurvasTests ventana = new CurvasTests();
